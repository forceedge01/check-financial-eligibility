Feature:
    ...
    Scenario: 1 - Test that the correct output is produced for the following set of data.
  ...
  Scenario: 2 - Test that the correct output is produced for the following set of data.
    Given I am using version 5 of the API
    And I create an assessment with the following details:
      | client_reference_id | NP-FULL-1  |
      | submission_date     | 2021-05-10 |
  ...
  Scenario: 3 -  Test that the correct output is produced for the following set of data.
    Given I am using version 5 of the API
    And I create an assessment with the following details:
      | client_reference_id | NP-FULL-1  |
      | submission_date     | 2021-05-10 |
  ...
  Scenario: 4 - Test that the correct output is produced for the following set of data.
    Given I am using version 5 of the API
    And I create an assessment with the following details:
      | client_reference_id | NP-FULL-1  |
      | submission_date     | 2021-05-10 |
  ...
  Scenario: 5 - Test that the correct output is produced for the following set of data.
    Given I am using version 5 of the API
    And I create an assessment with the following details:
      | client_reference_id | NP-FULL-1  |
      | submission_date     | 2021-05-10 |
  ...
  Scenario: 6 - Test that the correct output is produced for the following set of data.
    Given I am using version 5 of the API
    And I create an assessment with the following details:
      | client_reference_id | NP-FULL-1  |
      | submission_date     | 2021-05-10 |
